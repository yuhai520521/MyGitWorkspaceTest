...
//    GpioCtrlRegs.GPAMUX2.bit.GPIO19 = 1; // Configure GPIO19 as SPISTEA
    ...
    GpioCtrlRegs.GPBMUX2.bit.GPIO57 = 0; // Configure GPIO57 as GPS_CS

    GpioCtrlRegs.GPBDIR.bit.GPIO57 = 1;      // GPIO75配置为输出口
...
//    SpiaRegs.SPIFFRX.bit.RXFIFORESET=1;
	...
	SpiaRegs.SPIBRR = 49;               // 配置时钟频率为37.5/(36+1)=1M

    SpiaRegs.SPIPRI.bit.FREE = 0; 		 // 标准SPI模式
    SpiaRegs.SPICCR.bit.SPISWRESET = 1;  // Reset off
...
Uint16 GPSSPIExchangeData(Uint16 byte)
{
